...
// connection fails does it fall back to connecting to the "postgres" maintenance
// database to CREATE the target. This allows the service to work with external
// PostgreSQL instances where the user may not have CREATEDB privileges, as long
// as the database has been pre-created.

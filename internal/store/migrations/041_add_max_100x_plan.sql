-- 041_add_max_100x_plan.sql
--
-- Introduce a Max 100x tier sitting between Max 80x and Max 120x. Credit
-- budgets scale linearly from the per-unit rate established at Max 40x so the
-- 5h / 7d proportions stay identical. Model credit rates are shared across all
-- tiered plans and copied verbatim from 037_add_max_240x_plan.sql.
...
VALUES
    ('Max 100x', 'max_100x', 'Max 100x', 'Same usage limits as Claude Max (100x)', 10000, 499999, 1,
     '[{"window":"5h","window_type":"sliding","max_credits":55000000,"scope":"project"},{"window":"7d","window_type":"sliding","max_credits":416666500,"scope":"project"}]',
     '{

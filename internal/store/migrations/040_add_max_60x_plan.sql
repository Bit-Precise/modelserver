-- 040_add_max_60x_plan.sql
--
-- Introduce a Max 60x tier sitting between Max 40x and Max 80x. Credit budgets
-- scale linearly from the per-unit rate established at Max 40x so the 5h / 7d
-- proportions stay identical. Model credit rates are shared across all tiered
-- plans and copied verbatim from 037_add_max_240x_plan.sql.
...
VALUES
    ('Max 60x', 'max_60x', 'Max 60x', 'Same usage limits as Claude Max (60x)', 6000, 299999, 1,
     '[{"window":"5h","window_type":"sliding","max_credits":33000000,"scope":"project"},{"window":"7d","window_type":"sliding","max_credits":249999900,"scope":"project"}]',
     '{

...
const statusStyles: Record<string, string> = {
  ...
  non_retryable_error: "bg-red-500/10 text-red-500 border-red-500/20",
  retryable_error: "bg-blue-500/10 text-blue-500 border-blue-500/20",
  retry_exhausted: "bg-orange-500/10 text-orange-500 border-orange-500/20",
